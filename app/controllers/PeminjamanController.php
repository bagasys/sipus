...
class PeminjamanController extends BaseController
{
    public function manageAction()
    {
        ...
        $query = $this->modelsManager->createQuery('SELECT p.id, p.id_user, u.id, u.nama, p.id_buku, b.judul, p.status, p.tgl_hrs_kembali, p.denda, p.tgl_pinjam FROM Users u, Peminjaman p, Buku b
